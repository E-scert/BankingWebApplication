...
public class AccountHolder implements Serializable {
    ...
    private Date creationDate;
     @Column (table="BALANCE_TBL",nullable= false )
    private double balance;

    public AccountHolder() {
    }

    public AccountHolder(Long id, String fullName, String street, String city, String code, String cellNo, String emailAddress, Date creationDate, double balance) {
        this.id = id;
